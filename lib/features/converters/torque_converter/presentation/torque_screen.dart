...
import '../utils/torque_converter.dart';
...
class _TorqueScreenState extends ConsumerState<TorqueScreen> {
  ...
  String _inputUnit = TorqueConverter.units[0];
  String _outputUnit = TorqueConverter.units[1];
  ...
  void _convert() {
    ...
    double result = TorqueConverter.convert(val, _inputUnit, _outputUnit);
