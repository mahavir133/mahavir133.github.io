...
import '../utils/acceleration_converter.dart';
...
class _AccelerationScreenState extends ConsumerState<AccelerationScreen> {
  ...
  String _inputUnit = AccelerationConverter.units[0];
  String _outputUnit = AccelerationConverter.units[2];
  ...
  void _convert() {
    ...
    double result = AccelerationConverter.convert(val, _inputUnit, _outputUnit);
      ...
      child: Column(
        ...
        children: [
          GlassAutocomplete<String>(
            options: AccelerationConverter.units,
            initialValue: unit,
            onChanged: (val) {
              onChanged(val);
            },
