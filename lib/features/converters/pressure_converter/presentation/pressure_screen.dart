...
import '../utils/pressure_converter.dart';

class PressureScreen extends ConsumerStatefulWidget {
  const PressureScreen({super.key});

  @override
  ConsumerState<PressureScreen> createState() => _PressureScreenState();
}

class _PressureScreenState extends ConsumerState<PressureScreen> {
  final TextEditingController _inputController = TextEditingController();
  final TextEditingController _outputController = TextEditingController();

  String _inputUnit = PressureConverter.units[0];
  String _outputUnit = PressureConverter.units[3]; // atm
  ...
  void _convert() {
    ...
    double result = PressureConverter.convert(val, _inputUnit, _outputUnit);
      ...
      child: Column(
        ...
        children: [
          GlassAutocomplete<String>(
            options: PressureConverter.units,
            initialValue: unit,
            onChanged: (val) {
              onChanged(val);
            },
